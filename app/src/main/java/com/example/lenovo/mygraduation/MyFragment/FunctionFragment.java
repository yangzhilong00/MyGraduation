...
public class FunctionFragment extends Fragment {
    ...
    private TextView tv_newfunction;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tv_newfunction = view.findViewById(R.id.tv_newfunction);
        tv_newfunction.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((MainActivity)getActivity()).GotoNewFunctionActivity();
            }
        });
        return view;
    }
