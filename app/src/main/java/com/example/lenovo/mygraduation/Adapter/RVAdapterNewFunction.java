...
import com.example.lenovo.mygraduation.NewFunctionActivity;
...
public class RVAdapterNewFunction extends RecyclerView.Adapter<RVAdapterNewFunction.ViewHolder> {
private List<String> addFriendList;
private NewFunctionActivity context;
...
static class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public RVAdapterNewFunction(NewFunctionActivity context, List<String> addFriendList) {
        this.context = context;
        this.addFriendList = addFriendList;
    }

    @Override
    public RVAdapterNewFunction.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.newfunction_item, parent, false);
        final RVAdapterNewFunction.ViewHolder holder = new RVAdapterNewFunction.ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(RVAdapterNewFunction.ViewHolder holder, int position) {
